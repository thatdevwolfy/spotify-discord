...
function updatePlaybackState() {
    ...
    return $.ajax({
        ...
        statusCode: {
                    ...
                    $.ajax({
                        ...
                        statusCode: {
                            ...
                            404: () => {
                                ...
                                addLog(`(${playbackState.trackName}) does not have lyrics.. Status won't change.`, "warning");
            ...
            404: () => { addLog("Got unexpected error! For more details please read <a style=\"color: #ff0000;\" href=\"https://github.com/thatdevwolfy/spotify-discord#error-list\" target=\"_blank\">this</a>. <strong class=\"error\">Error code: 404</strong>", "error"); errorCount++ },
            502: () => { addLog("Got unexpected error! For more details please read <a style=\"color: #ff0000;\" href=\"https://github.com/thatdevwolfy/spotify-discord#error-list\" target=\"_blank\">this</a>. <strong class=\"error\">Error code: 502</strong>", "error"); errorCount++ }
        }
    });
}
...
(async function statusChanger() {
    setInterval(() => {
        if(startLog) {
            ...
            debugRequest10.text("Fetching...");
            debugRequest30.text("Fetching...");
            addLog("Ready. Script Made by ThatDevWolfy (https://github.com/thatdevwolfy)");
        }
        if(stopLog) {
            stopLog = false;
            ...
            addLog("Stopped. Script Made by ThatDevWolfy (https://github.com/thatdevwolfy)");
        }
        if(stopped) {
